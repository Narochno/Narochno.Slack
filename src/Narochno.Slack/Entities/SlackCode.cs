...
namespace Narochno.Slack.Entities
{
    public enum SlackCode
    {
        ...
        /// </summary>
        [EnumString("posting_to_general_channel_denied")]
